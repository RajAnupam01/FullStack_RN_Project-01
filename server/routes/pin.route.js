...
import { createPin, editPin, getAllPins, getCategoryPins, getCreatedPins, getOnePin, getSavedPins, toggleFollow, toggleLikePin, toggleSavePin } from '../controllers/post.controller.js';
